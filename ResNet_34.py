...
def Resnet34(input):
    ...
    with tf.name_scope("Conv1"):
        ...
        with tf.name_scope("Convolution"):
            layer_1 = tf.nn.relu(conv2d(input, kernel_1, strides=[1, 2, 2, 1], name='conv_layer_1') + bias_1,
                                 name='layer_1')
    # size:112*112
    ...
    with tf.name_scope("Block1"):
        with tf.name_scope("Conv2"):
            ...
            with tf.name_scope("Convolution"):
                layer_2 = tf.nn.relu(conv2d(Maxpool_1, kernel_2, strides=[1, 1, 1, 1], name='conv_layer_2') + bias_2,
                                     name='layer_2')
        ...
        with tf.name_scope("Conv3"):
            ...
            with tf.name_scope("Convolution"):
                layer_3 = tf.nn.relu(conv2d(layer_2, kernel_3, strides=[1, 1, 1, 1], name='conv_layer_3') + bias_3,
                                     name='layer_3')
    ...
    with tf.name_scope("Block2"):
        with tf.name_scope("Conv4"):
            ...
            with tf.name_scope("Convolution"):
                layer_4 = tf.nn.relu(conv2d(Res1, kernel_4, strides=[1, 1, 1, 1], name='conv_layer_4') + bias_4,
                                     name='layer_4')
        ...
        with tf.name_scope("Conv5"):
            ...
            with tf.name_scope("Convolution"):
                layer_5 = tf.nn.relu(conv2d(layer_4, kernel_5, strides=[1, 1, 1, 1], name='conv_layer_5') + bias_5,
                                     name='layer_5')
    ...
    with tf.name_scope("Block3"):
        with tf.name_scope("Conv6"):
            ...
            with tf.name_scope("Convolution"):
                layer_6 = tf.nn.relu(conv2d(Res2, kernel_6, strides=[1, 1, 1, 1], name='conv_layer_6') + bias_6,
                                     name='layer_6')
        ...
        with tf.name_scope("Conv7"):
            ...
            with tf.name_scope("Convolution"):
                layer_7 = tf.nn.relu(conv2d(layer_6, kernel_7, strides=[1, 1, 1, 1], name='conv_layer_7') + bias_7,
                                     name='layer_7')
    ...
    with tf.name_scope("Block4"):
        with tf.name_scope("Conv8"):
            ...
            with tf.name_scope("Convolution"):
                layer_8 = tf.nn.relu(conv2d(Res3, kernel_8, strides=[1, 2, 2, 1], name='conv_layer_8') + bias_8,
                                     name='layer_8')
        ...
        with tf.name_scope("Conv9"):
            ...
            with tf.name_scope("Convolution"):
                layer_9 = tf.nn.relu(conv2d(layer_8, kernel_9, strides=[1, 1, 1, 1], name='conv_layer_9') + bias_9,
                                     name='layer_9')
    ...
    with tf.name_scope("Block5"):
        with tf.name_scope("Conv10"):
            ...
            with tf.name_scope("Convolution"):
                layer_10 = tf.nn.relu(conv2d(Res4, kernel_10, strides=[1, 1, 1, 1], name='conv_layer_10') + bias_10,
                                      name='layer_10')
        ...
        with tf.name_scope("Conv11"):
            ...
            with tf.name_scope("Convolution"):
                layer_11 = tf.nn.relu(conv2d(layer_10, kernel_11, strides=[1, 1, 1, 1], name='conv_layer_11') + bias_11,
                                      name='layer_11')
    ...
    with tf.name_scope("Block6"):
        with tf.name_scope("Conv12"):
            ...
            with tf.name_scope("Convolution"):
                layer_12 = tf.nn.relu(conv2d(Res5, kernel_12, strides=[1, 1, 1, 1], name='conv_layer_12') + bias_12,
                                      name='layer_12')
        ...
        with tf.name_scope("Conv13"):
            ...
            with tf.name_scope("Convolution"):
                layer_13 = tf.nn.relu(conv2d(layer_12, kernel_13, strides=[1, 1, 1, 1], name='conv_layer_13') + bias_13,
                                      name='layer_13')
    ...
    with tf.name_scope("Block7"):
        with tf.name_scope("Conv14"):
            ...
            with tf.name_scope("Convolution"):
                layer_14 = tf.nn.relu(conv2d(Res6, kernel_14, strides=[1, 1, 1, 1], name='conv_layer_14') + bias_14,
                                      name='layer_14')
        ...
        with tf.name_scope("Conv15"):
            ...
            with tf.name_scope("Convolution"):
                layer_15 = tf.nn.relu(conv2d(layer_14, kernel_15, strides=[1, 1, 1, 1], name='conv_layer_15') + bias_15,
                                      name='layer_15')
    ...
    with tf.name_scope("Block8"):
        with tf.name_scope("Conv16"):
            ...
            with tf.name_scope("Convolution"):
                layer_16 = tf.nn.relu(conv2d(Res7, kernel_16, strides=[1, 2, 2, 1], name='conv_layer_16') + bias_16,
                                      name='layer_16')
        ...
        with tf.name_scope("Conv17"):
            ...
            with tf.name_scope("Convolution"):
                layer_17 = tf.nn.relu(conv2d(layer_16, kernel_17, strides=[1, 1, 1, 1], name='conv_layer_17') + bias_17,
                                      name='layer_17')
    ...
    with tf.name_scope("Block9"):
        with tf.name_scope("Conv18"):
            ...
            with tf.name_scope("Convolution"):
                layer_18 = tf.nn.relu(conv2d(Res8, kernel_18, strides=[1, 1, 1, 1], name='conv_layer_18') + bias_18,
                                      name='layer_18')
        ...
        with tf.name_scope("Conv19"):
            ...
            with tf.name_scope("Convolution"):
                layer_19 = tf.nn.relu(conv2d(layer_18, kernel_19, strides=[1, 1, 1, 1], name='conv_layer_19') + bias_19,
                                      name='layer_19')
    ...
    with tf.name_scope("Block10"):
        with tf.name_scope("Conv20"):
            ...
            with tf.name_scope("Convolution"):
                layer_20 = tf.nn.relu(conv2d(Res9, kernel_20, strides=[1, 1, 1, 1], name='conv_layer_20') + bias_20,
                                      name='layer_20')
        ...
        with tf.name_scope("Conv21"):
            ...
            with tf.name_scope("Convolution"):
                layer_21 = tf.nn.relu(conv2d(layer_20, kernel_21, strides=[1, 1, 1, 1], name='conv_layer_21') + bias_21,
                                      name='layer_21')
    ...
    with tf.name_scope("Block11"):
        with tf.name_scope("Conv22"):
            ...
            with tf.name_scope("Convolution"):
                layer_22 = tf.nn.relu(conv2d(Res10, kernel_22, strides=[1, 1, 1, 1], name='conv_layer_22') + bias_22,
                                      name='layer_22')
        ...
        with tf.name_scope("Conv23"):
            ...
            with tf.name_scope("Convolution"):
                layer_23 = tf.nn.relu(conv2d(layer_22, kernel_23, strides=[1, 1, 1, 1], name='conv_layer_23') + bias_23,
                                      name='layer_23')
    ...
    with tf.name_scope("Block12"):
        with tf.name_scope("Conv24"):
            ...
            with tf.name_scope("Convolution"):
                layer_24 = tf.nn.relu(conv2d(Res11, kernel_24, strides=[1, 1, 1, 1], name='conv_layer_24') + bias_24,
                                      name='layer_24')
        ...
        with tf.name_scope("Conv25"):
            ...
            with tf.name_scope("Convolution"):
                layer_25 = tf.nn.relu(conv2d(layer_24, kernel_25, strides=[1, 1, 1, 1], name='conv_layer_25') + bias_25,
                                      name='layer_25')
    ...
    with tf.name_scope("Block13"):
        with tf.name_scope("Conv26"):
            ...
            with tf.name_scope("Convolution"):
                layer_26 = tf.nn.relu(conv2d(Res12, kernel_26, strides=[1, 1, 1, 1], name='conv_layer_26') + bias_26,
                                      name='layer_26')
        ...
        with tf.name_scope("Conv27"):
            ...
            with tf.name_scope("Convolution"):
                layer_27 = tf.nn.relu(conv2d(layer_26, kernel_27, strides=[1, 1, 1, 1], name='conv_layer_27') + bias_27,
                                      name='layer_27')
    ...
    with tf.name_scope("Block14"):
        with tf.name_scope("Conv28"):
            ...
            with tf.name_scope("Convolution"):
                layer_28 = tf.nn.relu(conv2d(Res13, kernel_28, strides=[1, 2, 2, 1], name='conv_layer_28') + bias_28,
                                      name='layer_28')
        ...
        with tf.name_scope("Conv29"):
            ...
            with tf.name_scope("Convolution"):
                layer_29 = tf.nn.relu(conv2d(layer_28, kernel_29, strides=[1, 1, 1, 1], name='conv_layer_29') + bias_29,
                                      name='layer_29')
    ...
    with tf.name_scope("Block15"):
        with tf.name_scope("Conv30"):
            ...
            with tf.name_scope("Convolution"):
                layer_30 = tf.nn.relu(conv2d(Res14, kernel_30, strides=[1, 1, 1, 1], name='conv_layer_30') + bias_30,
                                      name='layer_30')
        ...
        with tf.name_scope("Conv31"):
            ...
            with tf.name_scope("Convolution"):
                layer_31 = tf.nn.relu(conv2d(layer_30, kernel_31, strides=[1, 1, 1, 1], name='conv_layer_31') + bias_31,
                                      name='layer_31')
    ...
    with tf.name_scope("Block16"):
        with tf.name_scope("Conv32"):
            ...
            with tf.name_scope("Convolution"):
                layer_32 = tf.nn.relu(conv2d(Res15, kernel_32, strides=[1, 1, 1, 1], name='conv_layer_32') + bias_32,
                                      name='layer_32')
        ...
        with tf.name_scope("Conv33"):
            ...
            with tf.name_scope("Convolution"):
                layer_33 = tf.nn.relu(conv2d(layer_32, kernel_33, strides=[1, 1, 1, 1], name='conv_layer_33') + bias_33,
                                      name='layer_33')
...
def backward(datasets, label, test_data, test_label):
    ...
    with tf.name_scope('train'):
        ...
        train_step = tf.train.AdamOptimizer(learning_rate).minimize(cross_entropy + l2 * weight_decay,global_step=global_step)
    ...
    with tf.Session() as sess:
        ...
        for i in range(STEPS):
            ...
            if i % 100 == 0:
                step, _ = sess.run([gloabl_steps, train_step],
                ...
                saver.save(sess, './resNet_34_model/modl_ckpt', global_step=i)
            else:
